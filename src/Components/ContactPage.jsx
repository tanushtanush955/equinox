const ContactPage = ({ colors }) => (
  <div className="min-h-screen flex flex-col items-center justify-center p-4 sm:p-8 transition-colors duration-500" style={{ backgroundColor: colors.background, color: colors.text }}>
	<div className="max-w-md text-center">
	  <h1 className="text-4xl sm:text-5xl md:text-6xl font-bold mb-4 sm:mb-6" style={{ fontFamily: 'Modo Badoni', color: colors.text }}>Contact Us</h1>
	  <p className="text-base sm:text-lg md:text-xl leading-relaxed mb-4" style={{ fontFamily: 'Raleway', color: colors.tertiary }}>
	  ...
	  <ul className="text-left space-y-2 sm:space-y-4 mb-8">
		<li className="text-base sm:text-lg" style={{ fontFamily: 'Raleway' }}>
		  <i className="fas fa-map-marker-alt" style={{ color: colors.secondary }}></i>
		  <span className="font-semibold ml-2" style={{ color: colors.secondary }}>Address:</span>
		  <br /> St. Joseph's Pre-University College,
		  <br /> FM Cariappa Road (Museum Road),
		  <br /> Bengaluru, Karnataka - 560025
		</li>
		<li className="text-base sm:text-lg" style={{ fontFamily: 'Raleway' }}>
		  <i className="fas fa-phone-alt" style={{ color: colors.secondary }}></i>
		  <span className="font-semibold ml-2" style={{ color: colors.secondary }}>Phone:</span> 9108357266 / 8147498934
		</li>
		<li className="text-base sm:text-lg" style={{ fontFamily: 'Raleway' }}>
		  <i className="fas fa-envelope" style={{ color: colors.secondary }}></i>
		  <span className="font-semibold ml-2" style={{ color: colors.secondary }}>Email:</span> sjpuc25@gmail.com
		</li>
	  </ul>
	  <h2 className="text-2xl font-bold mb-4" style={{ fontFamily: 'Modo Badoni', color: colors.tertiary }}>Our Location</h2>
